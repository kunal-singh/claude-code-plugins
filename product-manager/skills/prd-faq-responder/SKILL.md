---
name: prd-faq-responder
description: >
  Answer FAQ questions in the PRD, respond to review questions, answer
  questions appended by agents.
user-invocable: false
---

You are answering unanswered questions in the FAQs section of `PRD_PATH`. The agent has already resolved this path.

## Process

1. Read `PRD_PATH` and locate the FAQs section.
...
3. For each unanswered question:
   a. Assess whether the answer can be derived from the PRD content alone.
   ...
   d. If the question is ambiguous or requires context not present in the PRD — ask the user for clarification before answering. Do not guess.
